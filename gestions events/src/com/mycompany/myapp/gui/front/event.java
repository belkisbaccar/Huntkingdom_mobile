...
ev1.addparticipation(ee,foo);
    System.out.println(ee);
                           Dialog.show("Success","vous avez participé  avec succes",new Command("OK"));
                           btnval.remove();
                           /************************************************************************************/
                                NexmoClient client = NexmoClient.builder().apiKey("e0345f0a").apiSecret("VpiGk1IiCHTvAWWw").build();
                          String messageText = "vous avez participé a cette evenement"+"titre: "+data.toString()+" Date: "+data4.toString();
                            TextMessage message = new TextMessage("HappyKid", "21650347045", messageText);
...
Dialog.show("succes","vous avez faire un screenshot",new Command("OK"));
