  ...
  Form current;
   ...
   List<String> shop = new ArrayList<>(); 
        ...
        likes.setTextPosition(RIGHT);
         current.add(likes);
          ...
          for(int i=0; i<data.size(); i++){
             ...
             Button b = new Button("");
             FontImage.setMaterialIcon(b, FontImage.MATERIAL_ADD, 5);
    ...
    b2.addActionListener(new ActionListener() {
     ...
     {
        String url = "http://localhost/symfony2/web/uploads/images/"+nom+""; 
         return  url;
