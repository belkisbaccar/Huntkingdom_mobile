...
public class reclamation extends Form {
    ...
    public reclamation(Form current, Utilisateur user) {
        ...
        reclamation.setBgColor(0xccff99);
        /**
         * ***********************************************************************************************
         */
        ...
        reclamer.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                new ajoutReclamation(current, user).show();
            }
        });
        ...
        reponses.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                new afiicher_reponses(current, user).show();
            }
        });
        getToolbar().addMaterialCommandToLeftBar("back",
                FontImage.MATERIAL_BACKUP, ev -> {
                    new acceuil(current, user).show();
                });
 ...
 int a=newra.size();
        ...
        add(notif);
         ...
         addAll(Logo,reclamer, consulter,reponses);
    }
