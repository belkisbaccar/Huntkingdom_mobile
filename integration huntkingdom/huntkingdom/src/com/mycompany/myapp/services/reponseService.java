     ...
     public ArrayList<Reponse> parseReponses(String jsonText){
        ...
        JSONParser j = new JSONParser();
            ...
            for(Map<String,Object> obj : list){
                ...
                Map<String, Object> reclamation=(Map<String, Object>) obj.get("idReclamation");
                float id_reclamation = Float.parseFloat(reclamation.get("idReclamation").toString());
                r.setId_reclamation((int)id_reclamation);
                // Map<String, Object> reclamation1=(Map<String, Object>) obj.get("description");
                 r.setDesc_reclamation(reclamation.get("description").toString());
                 //Map<String, Object> reclamation2=(Map<String, Object>) obj.get("image");
                 r.setImg_reclamation(reclamation.get("image").toString());
               // r.setId_reclamation(reclamation.get("idReclamation").toString());
      ...
      public ArrayList<Reponse> getAllReponses( int user_id){
        String url = Statics.BASE_URL+"reps/"+user_id;
        req.setUrl(url);
        req.setPost(false);
      ...
      public ArrayList<Reponse> parseNew(String jsonText){
       ...
       public ArrayList<Reponse> getNewReponses(int user_id){
        String url = Statics.BASE_URL+"new_rep/"+user_id;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
