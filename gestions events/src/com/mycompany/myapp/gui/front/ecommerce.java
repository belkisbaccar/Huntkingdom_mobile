   ...
   List<String> shop = new ArrayList<>(); 
          ...
          for(int i=0; i<data.size(); i++){
             ...
             Label l = new Label(data.get(i).toString());
              ...
              Button reclamer= new Button("réclamer");
               reclamer.getAllStyles().setBorder(Border.createEmpty());
     reclamer.getAllStyles().setTextDecoration(Style.TEXT_DECORATION_UNDERLINE);
              Float prod_id =  (Float) ID.get(i);
    ...
    b.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                shop.add(l.getText()+"prix:"+l2.getText());
    ...
    b2.addActionListener(new ActionListener() {
           ...
           float ppp=Float.parseFloat(pp);
            ...
            c3.add(l2);
             ...
             c.add(c2).add(c3).add(b).add(b2).add(reclamer).add(share);
             current.add(c);
          }
